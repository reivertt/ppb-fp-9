...
class PlantLogs extends StatefulWidget {
  final String plantName;
  final String docID;

  const PlantLogs({super.key, required this.plantName, required this.docID});

  @override
  State<PlantLogs> createState() => _PlantLogsState();
}

class _PlantLogsState extends State<PlantLogs> {
